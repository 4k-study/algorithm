...
class Solution {
    public String solution(String play_time, String adv_time, String[] logs) {
        final int MAX_TIME = 360000;
        long[] times = new long[MAX_TIME];
        int advSeconds = calculateTotalSeconds(adv_time.split(":"));
        
        // 문자열 파싱
        for (String log : logs) {
            String[] l = log.split("-");
        
            int start = calculateTotalSeconds(l[0].split(":"));
            int end = calculateTotalSeconds(l[1].split(":"));
        ...
        long maxWindow = window;
        long maxStart = 0;
        
        for (int i = 1; i < MAX_TIME - advSeconds; i++) {
            window = window - times[i - 1] + times[i + advSeconds - 1];
            if (maxWindow < window) {
                maxWindow = window;
                maxStart = i;
            }
        ...
        return calculateTime(maxStart);
    }
    
    public int calculateTotalSeconds(String[] t) {
    ...
    public String calculateTime(long t1) {
        long hour = t1 / 3600;
        t1 = t1 % 3600;
